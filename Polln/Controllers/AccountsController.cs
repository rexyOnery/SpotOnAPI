...
namespace WebApi.Controllers
{
    ...
    public class AccountsController : BaseController
    {
        ...
        {
            var option = _accountService.ForgotPassword(model, Request.Headers["origin"]);
            return Ok(new { message = option });
        }
        ...
        [HttpGet("agents")]
        public ActionResult<IEnumerable<AccountResponse>> GetAllAgents()
        {
            var accounts = _accountService.GetAllAgents();
            return Ok(accounts);
        }
