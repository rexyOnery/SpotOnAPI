...
{
    public partial class LocalArea_Reload_migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gallerys_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArtisanTypeId = table.Column<int>(type: "int", nullable: false),
                    AccountId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artisans_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Artisans_ArtisanTypes_ArtisanTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artisans_AccountId",
                table: "Artisans",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Artisans_ArtisanTypeId",
                table: "Artisans",
                column: "ArtisanTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Gallerys_AccountId",
                table: "Gallerys",
                column: "AccountId");
